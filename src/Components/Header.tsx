...
const HeaderComponent = () => {
    ...
    return (
        <header className="fixed inset-x-4 top-0 p-5 bg-backgroundPrimary border-gray-600 mt-4 rounded-l flex justify-between items-center z-10 text-white">
            <div>
            ...
            <div className="flex items-center space-x-4">
                ...
                <label htmlFor="toggle" className="text-sm mr-3">{darkMode ? <RiSunLine/> : <RiMoonLine/>}</label>
                <button className="bg-transparent border-white border-2 hover:bg-white hover:text-primary text-white font-bold py-2 px-4 rounded">
                    Contact Me
                </button>
            </div>
        </header>
